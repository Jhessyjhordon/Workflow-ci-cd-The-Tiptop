...
export class HomeComponent {
  ...
  updateTag() {
    ...
    this.metaService.updateTag({ name: 'description', content: "Participez au grand jeu concours à Nice organisé par Thé Tiptop pour célébrer l'ouverture de notre nouvelle boutique et nos 10 ans d'excellence." }); // Meta description de la page
    ...
    this.metaService.updateTag({ name: 'keywords', content: 'jeu concours Nice' }); //Add keyword
    this.metaService.updateTag({ property: 'og:title', content: "Thé Tiptop - Grand Jeu Concours à Nice - Accueil" }) // Titre pour l'encadré dans les recherches
  }
