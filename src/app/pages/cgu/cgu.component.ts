...
export class CguComponent {
  title= "Thé Tiptop - Grand Jeu Concours à Nice - Conditions générales d'utilisation";
   ...
   addTag() {
    ...
    this.metaService.addTag({ property: 'og:title', content: "Thé Tiptop - Grand Jeu Concours à Nice - Conditions générales d'utilisation" }) // Titre pour l'encadré dans les recherches
  }
